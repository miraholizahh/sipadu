                    ...
                    <x-table>
                        ...
                        <tr>
                            ...
                            <td class="text-custom aksi-buttons">
                                <x-warning-button tag="a" href="{{ route('user.edit', $user->id) }}" class="text-custom">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536M9 13l6.768-6.768a2 2 0 112.828 2.828L11.828 15.828a2 2 0 01-1.414.586H9v-1.414a2 2 0 01.586-1.414z" />
                                    </svg>
                                    Edit
                                </x-warning-button>
