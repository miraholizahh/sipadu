    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-blue-600 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray">
                    <form method="post" action="{{ route('user.update', $user->id) }}" enctype="multipart/form-data" class="mt-6 space-y-6">
                        @csrf
                        @method('PUT')
                        <div class="max-w-xl">
                        ...
                        <div class="max-w-xl">
                            ...
                            <x-text-input id="email" type="text" name="email" class="mt-1 block w-full text-black" value="{{ old('email', $user->email) }}" required />
                        ...
                        <div class="max-w-xl">
                            ...
                            <x-text-input id="password" type="password" name="password" class="mt-1 block w-full text-black"
        placeholder="Biarkan kosong jika tidak ingin mengganti" />
                        ...
                        <div class="max-w-xl">
                            ...
                            <x-text-input id="password_confirmation" type="password" name="password_confirmation" class="mt-1 block w-full text-black"
        placeholder="Ulangi kata sandi jika mengubah" />
                        ...
                        <div class="max-w-xl mt-4">
                            ...
                            <select id="jenis_kelamin" name="jenis_kelamin" class="mt-1 block w-full text-black" required>
