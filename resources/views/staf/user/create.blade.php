                ...
                <div class="p-6 text-gray">
                    <form method="post" action="{{ route('user.store') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
                        ...
                        <div class="max-w-xl">
                            ...
                            <x-text-input id="nama" type="text" name="nama" class="mt-1 block w-full text-black" value="{{ old('nama') }}" required />
                            <x-input-error class="mt-2" :messages="$errors->get('nama')" />
                        </div>
                        <div class="max-w-xl">
                            <x-input-label for="email" value="Email" class="text-gray" />
                            <x-text-input id="email" type="email" name="email" class="mt-1 block w-full text-black" value="{{ old('email') }}" autocomplete="off" required />
                            <x-input-error class="mt-2" :messages="$errors->get('email')" />
                        </div>
                        <div class="max-w-xl">
                            <x-input-label for="telepon" value="Telepon" class="text-gray" />
                            <x-text-input id="telepon" type="text" name="telepon" class="mt-1 block w-full text-black" value="{{ old('telepon') }}" required />
                            <x-input-error class="mt-2" :messages="$errors->get('telepon')" />
                        </div>
                        <div class="max-w-xl">
                            <x-input-label for="password" value="Kata Sandi" class="text-gray" />
                            <x-text-input id="password" type="password" name="password" class="mt-1 block w-full text-black" value="" autocomplete="new-password" required />
                            <x-input-error class="mt-2" :messages="$errors->get('password')" />
                        </div>
                        <div class="max-w-xl">
                            <x-input-label for="password_confirmation" value="Konfirmasi Kata Sandi" class="text-gray" />
                            <x-text-input id="password_confirmation" type="password" name="password_confirmation" class="mt-1 block w-full text-black" value="" autocomplete="new-password" required />
                            <x-input-error class="mt-2" :messages="$errors->get('password_confirmation')" />
                        </div>
                        <div class="max-w-xl">
                            <x-input-label for="alamat" value="Alamat" class="text-gray" />
                            <x-text-input id="alamat" type="text" name="alamat" class="mt-1 block w-full text-black" value="{{ old('alamat') }}" required />
