        ...
        <div class="w-full max-w-2xl bg-white p-6 rounded-lg shadow-lg">
            <form method="post" action="{{ route('user.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="max-w-xl">
                    ...
                    <x-text-input id="password" type="password" name="password" class="mt-1 block w-full text-black" required />
                    <x-input-error class="mt-2" :messages="$errors->get('password')" />
                </div>

                <div class="max-w-xl">
                    <x-input-label for="password_confirmation" value="Konfirmasi Kata Sandi" class="text-gray" />
                    <x-text-input id="password_confirmation" type="password" name="password_confirmation" class="mt-1 block w-full text-black" required />
