<x-app-layout>
    ...
    <style>
        ...
        /* Tambahan: Bungkus teks panjang di Nama Gejala */
        .wrap-cell {
            max-width: 250px;
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-black">
                    <div class="text-right mb-4">
                        <x-primary-button tag="a" href="{{ route('knowledge_base.create') }}" class="text-custom">
                            Tambah Data
                        </x-primary-button>
                    </div>
                    ...
                    <x-table>
                        ...
                        <tr>
                            ...
                            <td class="text-custom wrap-cell">{{ $item->symptom->nama_gejala ?? '-' }}</td>
