<x-app-layout>
    ...
    <div class="min-h-screen flex items-center justify-center py-12">
        <div class="w-full max-w-2xl bg-white p-6 rounded-lg shadow-lg">
            <form method="post" action="{{ route('knowledge_base.store') }}" enctype="multipart/form-data" class="space-y-6">
                @csrf
                ...
                <div class="max-w-xl">
                    ...
                    <x-text-input id="bobot" type="text" name="bobot" class="mt-1 block w-full text-black" value="{{ old('bobot') }}" required />
