    ...
    <nav class="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
        <div class="flex items-center justify-between">
            <a class="flex-none" href="#">
                <img class="w-20 h-auto" src="{{ asset('images/logo-uptd.png') }}" alt="">
            </a>
            <a class="flex-none text-2xl font-semibold text-gray-800 dark:text-white" style="font-family: 'Lobster', cursive;" href="#">SIPADU-DBD</a>
            <div class="sm:hidden">
        ...
        <div id="navbar-with-collapse" class="hidden transition-all duration-[0.1ms] overflow-hidden basis-full grow sm:block">
            <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
                <a class="font-bold text-sm uppercase tracking-wide text-gray-800 hover:text-gray-600 dark:text-gray-200 dark:hover:text-gray-400" href="homenav">Beranda</a>
                <a class="font-bold text-sm uppercase tracking-wide text-gray-800 hover:text-gray-600 dark:text-gray-200 dark:hover:text-gray-400" href="profilenav">Tentang</a>
                ...
                @else
                <a class="font-bold text-sm uppercase tracking-wide text-gray-800 hover:text-gray-600 dark:text-gray-200 dark:hover:text-gray-400" href="{{ route('login') }}">Masuk</a>
                <a class="font-bold text-sm uppercase tracking-wide text-gray-800 hover:text-gray-600 dark:text-gray-200 dark:hover:text-gray-400" href="{{ route('register') }}">Registrasi</a>
                @endauth
                @endif
            </div>
